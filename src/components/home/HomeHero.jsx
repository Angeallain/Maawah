      ...
      <section className="relative h-[420px] rounded-[28px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-6">
          ...
          <h1 className="text-[48px] font-bold max-w-4xl leading-tight">
            Restoring Stability,
            <br />
            <span className="text-[#FF8C5A]">One Community</span> at a Time.
          </h1>

          <p className="mt-5 text-gray-200 max-w-2xl">
            Track, contribute, and witness the rebuilding of lives and
            infrastructure.
          </p>

          <button
            onClick={() => setShowCreateProject(true)}
            className="mt-8 hover:bg-white   transition-colors duration-300 ease-in-ou hover:text-[#6B8E23] bg-[#6B8E23] px-8 py-3 rounded-xl font-semibold"
          >
            Create a Project
          </button>
        </div>
