export default function ProjectCard({ title, description, progress }) {
  return (
    <div className="bg-white rounded-[28px] p-6 shadow-sm border border-gray-100">
      ...
      <button className="mt-6 w-full border transition-colors duration-300 ease-in-out border-[#6B8E23] hover:bg-[#6B8E23] hover:text-white text-[#6B8E23] py-3 rounded-full font-semibold">
        Contribute Now
      </button>
    </div>
  );
